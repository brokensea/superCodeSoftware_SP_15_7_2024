...
public class VerwaltungsBildungUnternehmenTest {
        ...
        public static void testVerwaltungsBildungUnternehmen() {
                ...
                // Test0: verteilenMitarbeiterZuKurs
                ...
                System.out.println(
                                "Mitarbeiter mit den wenigsten Modulen: "
                                                + (mitarbeiter != null ? mitarbeiter.getVorname() : "fail"));
                ...
                // Test 6: rechnenDurchsnittlichArbeitFindenZeit(Kurs kurs)
                // Test 7: rechnenPozentArbeitFinden()
                Teilnehmer teilnehmer2 = new Teilnehmer("teilnehmer2", "teilnehmer2", "Hauptstraße 3");
                ...
                System.out.println("prufen rechnenDurchsnittlichArbeitFindenZeit und rechnenPozentArbeitFinden");

                unternehmen.rechnenDurchsnittlichArbeitFindenZeit(kurs1);
                unternehmen.rechnenPozentArbeitFinden(kurs1);
